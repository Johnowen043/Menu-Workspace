...
KCM.SimpleKCM {
    ...
    property alias cfg_showCategorizedApps: showCategorizedApps.checked
    // New configuration property for directory icon display
    ...
    Kirigami.FormLayout {
        ...
        CheckBox {
            id: showCategorizedApps
            Kirigami.FormData.label: i18n("Show applications in category boxes")
            checked: false
        }

        CheckBox {
            id: useDirectoryIcons
            Kirigami.FormData.label: i18n("Use simple folder icons for categories")
            checked: false
            enabled: showCategorizedApps.checked
        }
